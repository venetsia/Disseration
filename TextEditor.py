...
num_outputs_l.grid(row=17,column=0, ipadx=3)
...
num_hidden_l.grid(row=18,column = 0,ipadx=4)
...
initial_connection_L.grid(row=19,column=0, ipadx=16)
...
initial_conection_value_l.grid(row=20,column=0, ipadx = 15)
...
feed_forward_L.grid(row=21, column=0, ipadx = 24)
...
activation_n_aggregation_o.grid(row=0, column =3, pady = 5, ipadx = 15)

#activation_default
activation_default_L = tk.Label(tab1, text = "Default Activation Func:")
activation_default_L.grid(row=1,column=3)
...
activation_default.grid(row=1,column=4)
...
activation_mutate_rate_L.grid(row=2,column=3, ipadx = 1)
...
activation_mutate_rate.grid(row=2,column=4)
...
activation_options_L.grid(row=3,column=3, ipadx=18)
...
listbox.grid(row=3,column=4, sticky='ns', pady = 2)
...
aggregation_mutate_rate_L.grid(row=4,column=3, ipadx = 4, pady=2)
...
aggregation_mutate_rate.grid(row=4,column=4)
...
aggregation_default_L.grid(row=5,column=3, ipadx = 8, pady= 2)
...
aggregation_default.grid(row=5,column=4)
CreateHelpMessage.CreateToolTip(aggregation_default_L, text ='aggregation_default\nThe default aggregation function attribute assigned to new nodes. If none is given, or “random” is specified, one of the aggregation_options will be chosen at random.')

#aggregation_options
aggregation_options_L = tk.Label(tab1, text = "Aggregatrions Func/s:", anchor = "w")
aggregation_options_L.grid(row=6,column=3, ipadx = 3)
...
listbox_aggregation_options.grid(row=6,column=4, sticky='ns')
...
node_bias_o.grid(row=7, column =3, pady = 5)

#bias_init_mean
bias_init_mean_l = tk.Label(tab1, text = "Bias init mean:")
bias_init_mean_l.grid(row=8,column=3)
...
bias_init_mean.grid(row=8,column=4)
...
bias_init_stdev_l.grid(row=9,column=3)
...
bias_init_type.grid(row=10,column=4)
...
bias_max_value_l.grid(row=11,column=3)
...
bias_max_value.grid(row=11,column=4)
...
bias_min_value_l.grid(row=12,column=3)
...
bias_min_value.grid(row=12,column=4)
...
bias_mutate_power_l.grid(row=13,column=3)
...
bias_mutate_power.grid(row=13,column=4)
...
bias_mutate_rate_l.grid(row=14,column=3)
...
bias_mutate_rate.grid(row=14,column=4)
...
bias_replace_rate_l.grid(row=15,column=3)
...
bias_replace_rate.grid(row=15,column=4)
...
genome_compatibility_o.grid(row=16, column =3, pady = 5)

#compatibility_threshold
compatibility_threshold_l = tk.Label(tab1, text = "Compatibility Threshold:")
compatibility_threshold_l.grid(row=17,column=3)
...
compatibility_threshold.grid(row=17,column=4)
...
compatibility_disjoint_coefficient_l.grid(row=18,column=3)
...
compatibility_disjoint_coefficient.grid(row=18,column=4)
...
compatibility_weight_coefficient_l.grid(row=19,column=3)
...
compatibility_weight_coefficient.grid(row=19,column=4)
...
connection_options_l.grid(row=0, column =5, pady = 5)

#conn_add_prob
conn_add_prob_l = tk.Label(tab1, text = "Connection add probability:")
conn_add_prob_l.grid(row=1,column=5)
...
conn_add_prob.grid(row=1,column=6)
CreateHelpMessage.CreateToolTip(conn_add_prob_l, text ='conn_add_prob\nThe probability that mutation will add a connection between existing nodes. Valid values are in [0.0, 1.0].')

#conn_delete_prob
conn_delete_prob_l = tk.Label(tab1, text = "Connection delete probability:")
conn_delete_prob_l.grid(row=2,column=5)
...
conn_delete_prob.grid(row=2,column=6)
...
enabled_default_L.grid(row=3, column=5)
...
enabled_default.grid(row=3, column =6)
...
enabled_mutate_rate_l.grid(row=4,column=5)
...
enabled_mutate_rate.grid(row=4,column=6)
...
enabled_rate_to_false_add_l.grid(row=5,column=5)
...
enabled_rate_to_false_add.grid(row=5,column=6)
...
enabled_rate_to_true_add_l.grid(row=6,column=5)
...
enabled_rate_to_true_add.grid(row=6,column=6)
...
node_add_prob_l.grid(row=7,column=5)
...
node_add_prob.grid(row=7,column=6)
...
node_delete_prob_l.grid(row=8,column=5)
...
node_delete_prob.grid(row=8,column=6)
...
response_l.grid(row=9, column =5, pady = 5)

#response_init_mean
response_init_mean_l = tk.Label(tab1, text = "Mean response deviation: ")
response_init_mean_l.grid(row=10,column=5)
...
response_init_mean.grid(row=10,column=6)
...
response_init_stdev_l.grid(row=11,column=5)
...
response_init_stdev.grid(row=11,column=6)
...
response_init_type_L.grid(row=12,column=5)
...
response_init_type.grid(row=12,column=6)
...
response_max_value_l.grid(row=13,column=5)
...
response_max_value.grid(row=13,column=6)
...
response_min_value_l.grid(row=14,column=5)
...
response_min_value.grid(row=14,column=6)
...
response_mutate_power_l.grid(row=15,column=5)
...
response_mutate_power.grid(row=15,column=6)
...
response_mutate_rate_l.grid(row=16,column=5)
...
response_mutate_power = ttk.Spinbox(tab1, from_= 0.0, to =1.0, increment=0.1)
response_mutate_power.grid(row=16,column=6)
...
response_replace_rate_l.grid(row=17,column=5)
...
response_replace_rate.grid(row=17,column=6)
...
single_structural_mutation_L.grid(row=18,column=5)
...
single_structural_mutation.grid(row=18,column=6)
...
structural_mutation_surer_L.grid(row=19,column=5)
...
structural_mutation_surer.grid(row=19,column=6)
CreateHelpMessage.CreateToolTip(structural_mutation_surer_L, text ='f this evaluates to True, then an attempt to add a node to a genome lacking connections will result in adding a connection instead; furthermore, if an attempt to add a connection tries to add a connection that already exists, that connection will be enabled. If this is set to default, then it acts as if it had the same value as single_structural_mutation (above). This defaults to “default”.')

# Weight Values
weight_l = tk.Label(tab1, text='Weight Values', font='Helvetica 12 bold')
weight_l.grid(row=20, column =5, pady = 5)

#weight_init_mean
weight_init_mean_l = tk.Label(tab1, text = "Mean weight:")
weight_init_mean_l.grid(row=21,column=5)
...
weight_init_mean.grid(row=21,column=6)
...
weight_init_stdev_l.grid(row=22,column=5)
...
weight_init_stdev.grid(row=22,column=6)
...
weight_init_type_L.grid(row=23,column=5)
...
weight_init_type.grid(row=23,column=6)
...
weight_max_value_l.grid(row=22,column=5)
...
weight_max_value.grid(row=22,column=6)
...
weight_min_value_l.grid(row=23,column=5)
...
weight_min_value.grid(row=23,column=6)
CreateHelpMessage.CreateToolTip(weight_min_value_l, text ='The minimum allowed weight value. Weights below this value will be clamped to this value.')

#weight_mutate_power
weight_mutate_power_l = tk.Label(tab1, text = "Weight Mutate power:")
weight_mutate_power_l.grid(row=24,column=5)
...
weight_mutate_power.grid(row=24,column=6)
...
weight_mutate_rate_l.grid(row=25,column=5)
...
weight_mutate_rate.grid(row=25,column=6)
...
weight_replace_rate_l.grid(row=26,column=5)
...
weight_replace_rate.grid(row=26,column=6)
